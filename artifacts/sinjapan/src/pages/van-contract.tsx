...
お問い合わせ窓口: info@sinjapan.jp（原則2週間以内に回答）
...
　連絡先: ${company?.email ?? company?.phone ?? 'info@sinjapan.jp'}
　（合同会社SIN JAPAN提携）
...
　④ 合同会社SIN JAPANサポート（info@sinjapan.jp）へ報告する
...
(2) 軽貨物事業（配送等）に使用する場合は、黒ナンバー（事業用軽自動車）登録が必要です。黒ナンバー取得手続きについては、当社担当者（info@sinjapan.jp）へご相談ください。
