...
const MOCK: any[] = [
  {
    id: 9001,
    name: '山田 一郎', email: 'yamada@kanagawa-delivery.jp',
    companyName: '山田配達サービス', corporateNumber: '4010001023948',
    creditStatus: 'pending', creditLimit: 0, creditUsed: 0,
    paymentTerms: 'Net30', billingAddress: '神奈川県横浜市中区山下町1-1',
    createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
  },
  {
    id: 9002,
    name: '中村 誠', email: 'nakamura@tokyo-haichi.co.jp',
    companyName: '中村軽貨物株式会社', corporateNumber: '7010001060842',
    creditStatus: 'approved', creditLimit: 3000000, creditUsed: 980000,
    paymentTerms: '月末締め翌月末払い', billingAddress: '東京都大田区蒲田5-10-3',
    createdAt: new Date(Date.now() - 21 * 86400000).toISOString(),
  },
  {
    id: 9003,
    name: '小林 達也', email: 'kobayashi@osaka-van.jp',
    companyName: '小林商事（個人事業主）', corporateNumber: '1200-01-010831',
    creditStatus: 'pending', creditLimit: 0, creditUsed: 0,
    paymentTerms: 'Net30', billingAddress: '大阪府大阪市住之江区南港北1-2-3',
    createdAt: new Date(Date.now() - 3 * 86400000).toISOString(),
  },
  {
    id: 9004,
    name: '加藤 裕子', email: 'kato@aichi-logistics.co.jp',
    companyName: '加藤フードデリバリー株式会社', corporateNumber: '2180001010369',
    creditStatus: 'approved', creditLimit: 5000000, creditUsed: 2100000,
    paymentTerms: 'Net60', billingAddress: '愛知県名古屋市中区錦2-14-19',
    createdAt: new Date(Date.now() - 90 * 86400000).toISOString(),
  },
  {
    id: 9005,
    name: '田辺 洋介', email: 'tanabe@kyushu-van.jp',
    companyName: '田辺軽バン運送', corporateNumber: '8290001061497',
    creditStatus: 'suspended', creditLimit: 1500000, creditUsed: 0,
    paymentTerms: 'Net30', billingAddress: '福岡県福岡市東区馬出3-1-1',
    createdAt: new Date(Date.now() - 55 * 86400000).toISOString(),
  },
  {
    id: 9006,
    name: '井上 麻衣', email: 'inoue@tohoku-amazon.jp',
    companyName: '井上デリバリーサービス', corporateNumber: '5400001019756',
